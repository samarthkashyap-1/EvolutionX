...
const Home = () => {
  return (
    ...
    <h1 className="text-6xl font-semibold  ">Welcome to Pokémon</h1>
    <div className="flex mx-auto gap-5 group">
      <h1 className="text-8xl  font-bold text-transparent bg-clip-text  transition-all duration-300 ease-in-out  font-outline-2 ">
        Evolution X
      </h1>
    ...
    <button className="flex w-fit mx-auto justify-center my-auto mt-10 gap-2 group items-center rounded-full hover:shadow-2xl shadow-white transition-all duration-300 ease-in-out bg-white  px-10 py-2 "
