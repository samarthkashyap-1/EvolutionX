...
import { PokemonData, TypeColor } from '../types'
...
const data : PokemonData[] = [
  ...
  const typeColor: TypeColor = {
    Electric: '#fbbf24',  // yellow-500
    Grass: '#22c55e',     // green-500
    Poison: '#a855f7',    // purple-500
    Fire: '#fdba74',      // orange-300
    Water: '#3b82f6',     // blue-500
    Fairy: '#ec4899',     // pink-500
    Normal: 'pink',    // gray-200
    Rock: '#c77844',      // gray-600
    Ground: '#a16207',    // yellow-800
    Flying: '#bfdbfe',    // blue-200
    Ghost: '#6b21a8',     // purple-700
    Dragon: '#dc2626',    // red-600
    Psychic: '#d8b4fe',   // purple-300
  };
  

  export {data, typeColor};